...
function getTemplateLoaderImplementation( loaderContext, resourceLoaders ) {
   return {
      closeTemplateModelSource( obj ) {
      },
      findTemplateModelSource( name ) {
...
function TemplateModel( obj, parent ) {
   ...
   if( Array.isArray( obj ) ) {
      return TemplateModelCollection( obj, parent );
   }
   if( obj instanceof Date ) {
      return TemplateModelDate( obj, parent );
   }
   if( typeof obj === 'boolean' ) {
      return TemplateModelBoolean( obj, parent );
   }
   if( typeof obj === 'number' ) {
      return TemplateModelNumber( obj, parent );
   }
   if( typeof obj === 'string' ) {
      return TemplateModelScalar( obj, parent );
   }
   if( typeof obj === 'function' ) {
      return TemplateModelMethod( obj, parent );
   }
   if( typeof obj === 'object' ) {
      return TemplateModelHash( obj, parent );
   }
...
function TemplateModelHash( obj ) {
   const keys = Object.keys( obj );
   return java.newProxy( TEMPLATE_HASH_MODEL, {
      get( key ) {
         return TemplateModelModel( obj[ key ], obj );
      },
      isEmpty() {
         return keys.length === 0;
      },
      keys() {
         return TemplateModelIterator( keys );
      },
      values() {
         return TemplateModelIterator( keys, obj );
      },
      size() {
         return keys.length;
      }
...
function TemplateModelCollection( obj ) {
   return java.newProxy( TEMPLATE_COLLECTION_MODEL, {
      iterator() {
         return TemplateModelIterator( obj );
      },
      isEmpty() {
         return obj.length === 0;
      },
...
function TemplateModelIterator( obj, parent ) {
   const get = parent ?
      k => parent[ k ] :
      k => k;
   ...
   return java.newProxy( TEMPLATE_MODEL_ITERATOR, {
      next() {
         if( i < obj.length ) {
            return TemplateModelModel( get( obj[ i++ ] ), parent || obj );
         }
...
function TemplateModelMethod( obj, parent ) {
   return java.newProxy( TEMPLATE_METHOD_MODEL, {
      exec( args ) {
         ...
         return TemplateModelModel( obj.apply( parent, a ) );
      }
   } );
}
...
function TemplateModelNumber( obj ) {
   return java.newProxy( TEMPLATE_NUMBER_MODEL, {
      getAsNumber() {
         return java.newInstanceSync( NUMBER, obj );
      }
   } );
}
...
function TemplateModelScalar( obj ) {
